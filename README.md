# ProVision
ProVision is a data analysis dashboard written in the R-shiny framework. This dashboard is designed to analyse label free proteomics data downstream from maxQuant.
